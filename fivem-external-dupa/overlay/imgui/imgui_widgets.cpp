...
bool ImGui::Checkbox(const char* label, bool* v)
{
    ...
    if (*v)
    {
        window->DrawList->AddRectFilled(pos + ImVec2(1, 1), pos + ImVec2(11, 11), ImColor(157, 176, 242));
        window->DrawList->AddText(pos + ImVec2(14, -4), ImColor(255, 255, 255, int(200 * it_active->second)), label);
    }
    else {
        if (hovered)
        {
            window->DrawList->AddRectFilled(pos + ImVec2(1, 1), pos + ImVec2(11, 11), ImColor(157, 176, 242, 100));
...
bool ImGui::SliderScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags)
{
    ...
    window->DrawList->AddRectFilled(frame_bb.Min, ImVec2(grab_bb.Min.x + 11, frame_bb.Max.y), ImColor(157 / 255.0f, 176 / 255.0f, 242 / 255.0f), 2);
